...
The public site now loads production content from Cloudflare first, but it will not let older saved KV content such as v1.5.3 override this newer build. If the footer still shows an old version, clear the browser site data or delete/update the `site-content` key in the `SITE_CONTENT` KV namespace.
...
## Clean rebase in v1.5.3
- Rebased back to the cleaner v1.5.3 structure.
...
## Rebuilt in v1.5.3
- Rebuilt the testimonial system on top of the clean v1.5.1 base.
