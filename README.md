...
The public site now loads production content from Cloudflare first, but it will not let older saved KV content such as v1.5.2 override this newer build. If the footer still shows an old version, clear the browser site data or delete/update the `site-content` key in the `SITE_CONTENT` KV namespace.
...
## Clean rebase in v1.5.2
- Rebased back to the cleaner v1.5.2 structure.
...
## Fixed in v1.5.2
- Sample testimonials are merged directly into the admin active testimonials list.
- Sample testimonials are also seeded into site-content.json for this build.
